...
namespace Blog.Models.Blog.Categoria
{
    public class CategoriaOrmService
    {
        ...
        public List<CategoriaEntity> ObterCategorias()
        {
            ...
            //var primeiraCategoria = _databaseContext.Categorias.First(); //FIRST() funciona apenas se tiver registro em base
            ...
            //var algumaCategoriaEspecifica = _databaseContext.Categorias.Single(c => c.Id == 3);  //SINGLE() funciona apenas se tiver registro em base
